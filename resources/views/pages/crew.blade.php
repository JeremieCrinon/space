@include('doctype')
    <body class="Crew--body">
        ...
        <section class="Crew--image__mobile Crew--image">
        ...
        <nav class="Crew--text--nav__mobile Crew--text--nav">
            <ul>
        ...
        <div class="Crew--container">
            <section class="Crew--text">
                @if(isset($subpage) && $subpage == "mission_specialist")
                    ...
                    <nav class="Crew--text--nav">
                        <ul>
                            <li><a class="Crew--text--nav--link" href="{{ url('/crew/commander') }}"></a></li>
                            <li><a class="Crew--text--nav--link Crew--text--nav--link--current" href="{{ url('/crew/mission_specialist') }}"></a></li>
                ...
                @elseif(isset($subpage) && $subpage == "pilot")
                    ...
                    <nav class="Crew--text--nav">
                        <ul>
                            ...
                            <li><a class="Crew--text--nav--link  Crew--text--nav--link--current" href="{{ url('/crew/pilot') }}"></a></li>
                            <li><a class="Crew--text--nav--link" href="{{ url('/crew/engineer') }}"></a></li>
                        </ul>
                    </nav>
                @elseif(isset($subpage) && $subpage == "engineer")
                    ...
                    <nav class="Crew--text--nav">
                        <ul>
                            ...
                            <li><a class="Crew--text--nav--link" href="{{ url('/crew/mission_specialist') }}"></a></li>
                            <li><a class="Crew--text--nav--link" href="{{ url('/crew/pilot') }}"></a></li>
                            <li><a class="Crew--text--nav--link Crew--text--nav--link--current" href="{{ url('/crew/engineer') }}"></a></li>
                        </ul>
                    </nav>
                @else
