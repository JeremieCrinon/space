<header class="Website--header">
    ...
    <nav class="Website--header--menu" role="navigation">
        <ul>
            ...
            <li @if(isset($pageName) && $pageName == "home")class="Website--header--li--current"@endif><a href="{{ url('/dashboard') }}">{{ __('HOME') }}</a></li>
            <li @if(isset($pageName) && $pageName == "edit")class="Website--header--li--current"@endif><a href="{{ url('/edit') }}">{{ __('EDIT CONTENT') }}</a></li>
            <li @if(isset($pageName) && $pageName == "profile")class="Website--header--li--current"@endif><a href="{{ url('/profile') }}">{{ __('PROFILE') }}</a></li>
